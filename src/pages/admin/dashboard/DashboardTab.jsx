...
function DashboardTab() {
  ...
  const { mode, products, deleteProduct, editHandle, orders, users } = context;
  // console.log("products : ", products); // remove clg before hosting
            ...
            <TabPanel>
              ...
              <div className="relative overflow-x-auto mb-16">
                ...
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                  ...
                  {orders.map((allOrder, i) => {
                    return (
                      <tbody key={i + 1}>

                        {
                          // console.log('allOrder.cartItems : ', allOrder.cartItems)
                        ...
                        >
                          ...
                          <td
                            className="px-6 py-4 text-black text-center"
                            style={{ color: mode === "dark" ? "white" : "" }}
                          >
                            ₹ {item.price}
                          </td>
